...
/*
__attribute__(( naked )) unsigned int OS_CPU_SR_Save(void)
{
	__asm volatile														\
	(
		"MRS     R0, PRIMASK"
...
__attribute__(( naked )) void OS_CPU_SR_Restore(unsigned int sr)
{
	__asm volatile														\
		(
				"MSR     PRIMASK, R0"
...
__attribute__(( naked )) void        CPU_IntDis       (void)
{
	__asm volatile														\
		(
				"CPSID   I"
...
__attribute__(( naked )) void        CPU_IntEn        (void)
{
	__asm volatile														\
			(
					"CPSIE   I"
